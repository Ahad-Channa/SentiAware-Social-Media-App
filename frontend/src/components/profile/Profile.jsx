...
const Profile = () => {
  ...
  const user = {
    ...
    stats: {
      following: loggedInUser.following || 0,
      followers: loggedInUser.followers || 0,
      positiveScore: loggedInUser.positiveScore || '0%',
      totalPosts: loggedInUser.totalPosts || 0,
      achievements: loggedInUser.achievements || 0,
    },
  };
                ...
                <div className="flex-grow pt-1">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="px-3 py-1.5 text-sm bg-green-100 text-green-800 rounded-full">Positive Member</span>
                      <Link 
                        to="/edit-profile" 
            ...
            <div className="flex justify-between">
              <div className="flex space-x-3">
                ...
                <div>
                  ...
                  <p className="mt-2">Grateful for this supportive community. You all make a difference! 🌟</p>
                </div>
              </div>
